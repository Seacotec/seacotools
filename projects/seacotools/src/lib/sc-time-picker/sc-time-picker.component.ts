...
export class ScTimePickerComponent implements ControlValueAccessor, AfterViewInit, OnDestroy {
  ...
  get computedClasses(): string {
    const defaultClasses =
      ...
      'dark:disabled:bg-gray-600 dark:text-gray-100 dark:disabled:text-gray-300 w-full px-3 border rounded ' +
      'focus:border-indigo-500 h-9 placeholder-gray-500 placeholder-opacity-70';

    const borderColorClass = this.hasError ? 'border-red-500 dark:border-red-400' : 'border-gray-400 dark:border-gray-600';
